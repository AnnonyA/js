...
it("recovers add3, twice, and scenario from the captured 2.1.3 CFF regression", async () => {
  const obfuscated = readFileSync(
    resolve(testDir, "../fixtures/2.1.3/controlFlowFlattening-regression/obfuscated.js"),
    "utf8",
  );
