...
export function evaluateOuter(node: t.Node, model: Cff213Model, states: readonly number[]): Value {
...
export function callPath(call: t.CallExpression, model: Cff213Model, states: readonly number[]): string[] | null {
...
export function nestedStatesFromOuterTrace(
  model: Cff213Model,
